CREATE INDEX IF NOT EXISTS concurrentes_dni_idx ON public.concurrentes (dni);
...
GRANT EXECUTE ON FUNCTION public.importar_concurrentes_lote(jsonb) TO authenticated;